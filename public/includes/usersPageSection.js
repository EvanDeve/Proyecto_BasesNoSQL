(function renderUsersPageSection() {
  const root = document.getElementById("users-page-section-root");
  if (!root) return;
    ...
    <section class="users-section section-block">
      <div class="container">
        <div class="text-center mb-5">
          ...
          <h1 class="section-title users-main-title">Gestión de usuarios</h1>
          <p class="section-text users-main-text mx-auto" style="max-width: 760px;">
            Desde esta página puedes registrar nuevos usuarios, visualizar los usuarios
            existentes.
          </p>
        </div>
        ...
        <div class="row g-4 align-items-start">
          <div class="col-12 col-xl-4">
            <div class="panel-card">
              ...
              <p class="form-text">
                Completa la información para agregar un usuario a la plataforma.
              </p>
              ...
              <form id="user-form" novalidate>
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    class="form-control custom-input"
                    type="email"
                    placeholder="Ej: andres@email.com"
                    required
                  />
                </div>
              ...
              <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
                <div>
                  ...
                  <p class="form-text mb-0">
                    Aquí se mostrarán todos los usuarios cargados.
                  </p>
                </div>
