      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
          <ul class="navbar-nav ms-auto gap-lg-3">
            <li class="nav-item"><a class="nav-link active" href="#hero-root">Inicio</a></li>
            <li class="nav-item"><a class="nav-link" href="#about-root">Proyecto</a></li>
            <li class="nav-item"><a class="nav-link" href="#modules-preview-root">Módulos</a></li>
            <li class="nav-item"><a class="nav-link" href="#ecosystem-preview-root">Ecosistema</a></li>
            <li class="nav-item"><a class="nav-link" href="./usuarios.html">Usuarios</a></li>
            <li class="nav-item"><a class="nav-link" href="#footer-root">Contacto</a></li>
          </ul>
        </div>
      </div>
    </nav>
